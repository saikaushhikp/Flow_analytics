...
parser = argparse.ArgumentParser(description='Oulu Crosswalk Pedestrian-Vehicle Detection')
parser.add_argument('--start-date', type=str, default="2025-08-22",
                    help='Start date (YYYY-MM-DD). Default: 2025-08-22')
parser.add_argument('--end-date', type=str, default="2025-08-22",
                    help='End date (YYYY-MM-DD). Default: 2025-08-22')
