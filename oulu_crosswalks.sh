#!/bin/bash
# Oulu Crosswalk Detection - Process all available days
# Handles gaps in data automatically
# Usage: ./oulu_crosswalks.sh

echo "=========================================="
echo "OULU CROSSWALK DETECTION - ALL AVAILABLE DAYS"
echo "=========================================="
...
# Confirmation
echo "This will process all $total_days days of Oulu crosswalk detection."
...
echo "=========================================="
echo "OULU CROSSWALK DETECTION COMPLETE"
echo "=========================================="
echo "Processed: $count days"
echo "Results saved in: /home/ubuntu/results/prem/mdrac/oulu/crosswalks/"
echo "=========================================="
