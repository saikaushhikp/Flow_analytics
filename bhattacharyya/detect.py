...
def run_detection(
    ...
    print("\n→ Generating nearby pairs in-memory...")
    ...
    print(f"  ✓ Generated {len(base_pairs):,} nearby pairs")
    ...
    print("\n→ Computing safety envelopes & BC² Overlap Probability...")
    ...
    if not detections.empty:
        print("→ Applying post-processing filters (Approach Vector, Size Sanity, Deduplication)...")
