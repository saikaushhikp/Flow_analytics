...
def __getattr__(name):
    ...
    if name == 'extract_risk_vectors':
        from .risk_vector import extract_risk_vectors
        return extract_risk_vectors
    if name == 'get_feature_names':
        from .risk_vector import get_feature_names
        return get_feature_names
    if name == 'generate_risk_vectors':
