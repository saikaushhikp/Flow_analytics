#!/bin/bash
# Brussels Lane Detection - Process all days (June 1 to Jun 14)
# Usage: ./brussels_lanes.sh

echo "=========================================="
echo "BRUSSELS LANE DETECTION - ALL DAYS"
echo "=========================================="
echo "Date Range: 2025-06-03 to 2025-06-14"
...
echo "=========================================="
echo "BRUSSELS LANE DETECTION COMPLETE"
echo "=========================================="
echo "Processed: $count days"
echo "Results saved in: /home/ubuntu/results/prem/mdrac/brussels/lanes/"
echo "=========================================="
